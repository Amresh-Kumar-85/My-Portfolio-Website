...
export const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_oxd91zc", // 🔁 Replace this
        "template_6tpk8xb", // 🔁 Replace this
        formRef.current,
        "1HQnzVOCisai4AUrU"   // 🔁 Replace this
      )
      .then(
        () => {
          toast({
            title: "Message sent!",
            description: "Thanks for reaching out! I’ll be in touch with you shortly.",
          });
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          ...
          new opportunities — feel free to get in touch and let's create
            ...
            <form className="space-y-6" ref={formRef} onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="I’d like to start a conversation about..."
                />
              </div>
